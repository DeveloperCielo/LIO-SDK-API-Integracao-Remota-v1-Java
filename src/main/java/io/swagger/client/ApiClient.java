...
public class ApiClient {
    ...
    private String basePath = "https://api.cielo.com.br/sandbox-lio/order-management/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cielo.com.br/sandbox-lio/order-management/v1
